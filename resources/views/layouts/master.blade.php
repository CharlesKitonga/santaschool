  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="./images/logo.svg" alt="Clininc Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Santa Tilahm</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item has-treeview ">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <router-link to="/school-home" class="nav-link ">
                    ...
                    <li class="nav-item">
                        <router-link to="/admin-philosophy" class="nav-link ">
                            <i class="fas fa-address-card nav-icon text-cyan"></i>
                            <p>School Vision</p>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link to="/admin-gallery" class="nav-link ">
                            <i class="fas fa-photo-video nav-icon text-cyan"></i>
                            <p>School Gallery</p>
                        </router-link>
                    </li>
                </ul>
